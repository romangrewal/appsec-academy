...
resource "linode_instance" "nano" {
  label      = "centos-stream-9-frontend"
  type       = "g6-nanode-1"
...
locals {
  existing_content = fileexists("${path.module}/../../appsec-ansible/inventory.ini") ? file("${path.module}/../../appsec-ansible/inventory.ini") : ""
...
resource "local_file" "ansible_inventory" {
  filename = "${path.module}/../../appsec-ansible/inventory.ini"
